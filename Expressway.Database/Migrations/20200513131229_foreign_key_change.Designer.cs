...
namespace Expressway.Database.Migrations
{
    ...
    [Migration("20200513131229_foreign_key_change")]
    partial class foreign_key_change
    {
            ...
            modelBuilder.Entity("Expressway.Model.Domain.PassengerRideRequest", b =>
                {
                    ...
                    b.Property<int>("RequestingSeatCount");

                    b.Property<long?>("SeatId");

                    b.Property<long?>("SeatRideId");

                    b.HasKey("RideId", "PassengerId");

                    b.HasIndex("PassengerId");

                    b.HasIndex("SeatId", "SeatRideId");
            ...
            modelBuilder.Entity("Expressway.Model.Domain.VehicleModel", b =>
                {
                    ...
                    b.Property<int>("MaxAvailableSeatCount");
            ...
            modelBuilder.Entity("Expressway.Model.Domain.PassengerRideRequest", b =>
                {
                    ...
                    b.HasOne("Expressway.Model.Domain.Seat")
                        .WithMany("PassengerRideRequests")
                        .HasForeignKey("SeatId", "SeatRideId");
                });
            ...
            modelBuilder.Entity("Expressway.Model.Domain.Ride", b =>
                {
                    ...
                    b.HasOne("Expressway.Model.Domain.DriverVehicle", "DriverVehicle")
                        .WithMany("Rides")
                        .HasForeignKey("DriverId", "VehicleId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
